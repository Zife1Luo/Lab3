...
public class JSONTranslationExample {
    ...
    public static final String CANADA_CODE = "can";
    ...
    public String getCanadaCountryNameSpanishTranslation() {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            if (country.getString("alpha3").equalsIgnoreCase(CANADA_CODE)) {
                return country.getString("es");
            }
        }
        return "Translation not found for Canada";
    }

    // Task: Complete the method below to generalize the above to get the country name
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            if (country.getString("alpha3").equalsIgnoreCase(countryCode)) {
                if (country.has(languageCode)) {
                    ...
                    result = "Translation not available for the specified language.";
                }
                break;
            }
        }
