...
public class CountryCodeConverter {
        ...
        try {
            ...
            for (String line : lines.subList(1, lines.size())) {
                ...
                if (parts.length >= EXPECTED_COLUMNS) {
                    ...
                    countryCodeMap.put(alpha3Code.toLowerCase(), countryName);
                    countryToCodeMap.put(countryName.toLowerCase(), alpha3Code);
                    numCountries++;
                }
            }
        }
    ...
    public String fromCountryCode(String code) {
        ...
        return countryCodeMap.get(code.toLowerCase());
    }
    ...
    public String fromCountry(String country) {
        // Task: update this code to use an instance variable to return the correct value
        return countryToCodeMap.get(country.toLowerCase());
    }
